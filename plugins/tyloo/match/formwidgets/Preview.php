<?php namespace Tyloo\Match\FormWidgets;
...
/**
 * Preview area for the Create/Edit Match form.
 *
 * @package tyloo\match
...
class Preview extends FormWidgetBase
{
    ...
    {
        $this->vars['preview_html'] = Match::formatHtml($this->model->content, true);
    ...
    {
        $this->checkUploadMatchback();
    }

    protected function checkUploadMatchback()
    {
        if (!post('X_MATCH_IMAGE_UPLOAD'))
            return;
